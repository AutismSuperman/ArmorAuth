...
public interface AuthFactorRepository extends JpaRepository<AuthFactor, String> {
    ...
    List<AuthFactor> findByUserIdAndFactorType(String userId, String factorType);

    Optional<AuthFactor> findByUserIdAndFactorTypeAndEnabledTrue(String userId, String factorType);

    List<AuthFactor> findByUserIdAndEnabledTrue(String userId);
